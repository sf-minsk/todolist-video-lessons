...
import {AddTodolistActionType, RemoveTodolistActionType, setTodoListsACActionType} from './todolists-reducer';
...
export type FetchTaskActionTasks = ReturnType<typeof fetchTaskAC>
